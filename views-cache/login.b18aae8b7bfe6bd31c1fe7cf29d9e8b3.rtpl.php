...
<head>
  ...
  <!-- Navegador se adapta ao tamanho da tela -->
  ...
  <! - AVISO: o Respond.js não funciona se você visualizar a página via arquivo: // ->--[if lt IE 9]>
...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Ecommerce</b></a>
  </div>
  <!-- /.login-logo -->
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox"> Salvar para mim
            </label>
          </div>
        </div>
        <!-- /.col -->
